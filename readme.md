...
2. We will create 2 views within the React app. 

<p align="center">
<img width="350" src="https://user-images.githubusercontent.com/8760590/207462582-75f80b3a-30be-4ee7-a93d-f62ad8064b71.png">
</p>

3. Navigate to `client/src/` and create a new file called `OtherPage.js`. Enter the following code: 
...
4. Navigate to `client/src` and create a file called `Fib.js`. Enter the following code: 
...
5. We need to add to the Fib.js file the following code to execute our backend logic and render the informatino back to the UI: 
...
6. Ensure that the `react-router-dom` & `axios` dependencoes are added to the `client` package.json file. You can do this with the following command: 
...
7. Now we need to navigate to the `client/src/App.js` file and inmport the `Fib.js` & `OtherPage.js` components. Overwrite the `App.js` file with the following code: 

```js
import logo from './logo.svg';
import { BrowserRouter as Router, Route, Link } from 'react-router-dom'
import Fib from './Fib';
import OtherPage from './OtehrPage'
import './App.css';
